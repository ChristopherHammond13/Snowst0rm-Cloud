...
copy Firmware\dfu\iBSS.n72ap.RELEASE.dfu .\iBSS_3.1.2.img3
..\cp.exe ./41files/kernelc* ./kernel
..\cp.exe ./Firmware/dfu/iBEC.n72ap.RELEASE.dfu ./iBEC_3.1.2.img3
copy .\41files\Firmware\dfu\iBSS.n72ap.RELEASE.dfu .\iBSS_4.0.img3
copy .\41files\Firmware\dfu\iBEC.n72ap.RELEASE.dfu .\iBEC_4.0.img3
copy .\41files\Firmware\all_flash\all_flash.n72ap.production/DeviceTree.n72ap.img3 .\devtree
copy ..\Files\filler filler
